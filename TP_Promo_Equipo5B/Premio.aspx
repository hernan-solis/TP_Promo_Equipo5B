...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <asp:Repeater ID="RepRepetidor" runat="server" OnItemDataBound="RepRepetidor_ItemDataBound" OnItemCommand="RepRepetidor_ItemCommand">
            <ItemTemplate>
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <asp:Button ID="btnQuieroEste" runat="server" Text="Quiero este!" CssClass="btn btn-primary" CommandName="Seleccionar" CommandArgument='<%# Eval("Id") %>' />
                        </div>
                    </div>
                </div>
            </ItemTemplate>
